...
/**
 * A utility class for packing and unpacking two values—one of 24 bits and one of 8 bits— into a
 * single 32-bit integer.
 * <p>
 * The most significant 24 bits store the 24-bit value, while the least significant 8 bits store the
 * 8-bit value.
 * </p>
 */
public final class Bits32_24_8 {
    ...
    private Bits32_24_8() {
        throw new UnsupportedOperationException(
                "Bits32_24_8 is a utility class and cannot be instantiated");
    }
     ...
     * @throws IllegalArgumentException If the 24-bit value exceeds 24 bits or the 8-bit value
     *                                  exceeds 8 bits.
     */
