...
/**
 * Implementation of the {@link Trips} interface that accesses flattened data in a
 * {@link ByteBuffer}.
 */
public final class BufferedTrips implements Trips {
    ...
    /**
     * Constructs a BufferedTrips from a string table and a buffer containing the flattened data.
     *
